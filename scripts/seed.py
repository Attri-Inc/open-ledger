...
def seed_accounts(conn: sqlite3.Connection) -> dict[str, str]:
    ...
    audit(
        ...
        "ledger",
        None,
        f"Initialized chart of accounts ({len(ACCOUNTS)} accounts)",
        now,
    )
    return by_code
...
def post(
    ...
    audit(
        ...
        "transaction",
        txn_id,
        f'Posted "{description}" · {fmt(debits)} ({len(lines)} lines)',
        created_at,
    )
    return txn_id
...
def seed_transactions(conn: sqlite3.Connection, by_code: dict[str, str]) -> None:
    ...
    post(
        ...
        "TRF",
        [("1010", "credit", 500_000), ("1020", "debit", 500_000)],
    ...
    post(
        ...
        "TRF",
        [("1010", "credit", 300_000), ("1030", "debit", 300_000)],
        "2026-01-03T10:20:00+00:00",
    )
    post(
        conn,
        by_code,
        ...
        "TRF",
        [("1020", "credit", 50_000), ("1030", "debit", 50_000)],
    ...
    post(
        ...
        "Office rent — January",
        "BILL",
        [("5000", "debit", 120_000), ("1010", "credit", 120_000)],
    ...
    post(
        ...
        "BILL",
        [("5000", "debit", 60_000), ("2000", "credit", 60_000)],
    ...
    post(
        ...
        "PAY",
        [("5100", "debit", 300_000), ("1010", "credit", 300_000)],
    ...
    for month, sale in monthly_sales.items():
        ...
        post(
            ...
            "INV",
            [("1010", "debit", sale), ("4000", "credit", sale)],
        ...
        post(
            ...
            "BILL",
            [("5000", "debit", 120_000), ("1010", "credit", 120_000)],
            f"2026-{month}-15T16:45:00+00:00",
        )
        post(
            conn,
            by_code,
    ...
    post(
        ...
        by_code,
        d(6),
        "Sale of services — invoice #1101",
        "INV",
        [("1000", "debit", 180_000), ("4000", "credit", 180_000)],
        ts(6),
    )
    post(
        conn,
    ...
    post(
        ...
        by_code,
        d(3),
        "Transfer from Wallet B to Wallet A",
        "TRF",
...
def seed_settings(conn: sqlite3.Connection) -> None:
    ...
    conn.execute(
        ...
        "VALUES (1, 'OpenLedger Demo Co', 'USD', ?, ?)",
        (now, now),
    )
